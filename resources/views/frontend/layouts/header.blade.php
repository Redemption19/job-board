          ...
          <div class="block-signin">
            ...
            @auth
                @if (auth()->user()->role === 'company')
                    <a class="btn btn-default btn-shadow ml-40 hover-up" style="width: 210px" href="{{ route('company.dashboard') }}">Company Dashobard</a>
                @elseif(auth()->user()->role === 'candidate')
                    <a class="btn btn-default btn-shadow ml-40 hover-up" style="width: 210px" href="{{ route('candidate.dashboard') }}">Job Seeker Dashboard</a>
                @endif
            @endauth
          </div>
        </div>
    ...
    <div class="mobile-header-wrapper-inner">
      <div class="mobile-header-content-area">
        <div class="perfect-scroll">
          ...
          <div class="mobile-menu-wrap mobile-header-border">
            ...
            <nav>
              <ul class="mobile-menu font-heading">
                <li class=""><a class="active" href="{{ route('home') }}">Home</a>
                </li>
          ...
          <div class="site-copyright">Copyright 2024 &copy; joblist. <br>CareerEdu</div>
        </div>
      </div>
    </div>
  </div>
          ...
          <div class="mobile-menu-wrap mobile-header-border">
            ...
            <nav>
              <ul class="mobile-menu font-heading">
                ...
                <li class=""><a href="{{ route('jobs.index') }}">Find a Job</a>

                </li>
                <li class=""><a href="{{ route('companies.index') }}">Companies</a>

                </li>
                <li class="has-children"><a href="{{ route('candidates.index') }}">Job Seekers</a>
